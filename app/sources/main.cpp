...
int main(int argc, char *argv[])
{
	...
	application->setApplicationName(Fk::ApplicationTitle);
	...
	// This is used to create QDateTime from the right locale
	QLocale::setDefault(QLocale(config->value(Fk::Language).toString()));
	...
	// Resize and show window after creation
